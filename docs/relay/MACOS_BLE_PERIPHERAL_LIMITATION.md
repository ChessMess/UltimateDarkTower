...
_Docs: [Index](README.md) > Operator > macOS BLE limitation_
...
(incl. `0x180A`) when acting as a BLE **peripheral**. The official _Return to Dark
Tower_ companion app reads the DIS **firmware revision** to decide whether the tower
