(() => {
  ...
  var UltimateDarkTower = class {
    ...
    async MultiCommand(rotate2, lights2, soundIndex) {
      ...
      if (rotate2) {
        this.updateGlyphPositionsForRotation("top", rotate2.top);
        this.updateGlyphPositionsForRotation("middle", rotate2.middle);
        this.updateGlyphPositionsForRotation("bottom", rotate2.bottom);
      }
      return result;
    }
    /**
