(() => {
  ...
  var UltimateDarkTower = class {
    ...
    async Lights(lights2) {
      ...
      this.logDetail && this.logger.debug(`Light Parameter ${JSON.stringify(lights2)}`, "[UDT]");
    ...
    async MultiCommand(rotate2, lights2, soundIndex) {
      this.logDetail && this.logger.debug(`MultiCommand Parameters ${JSON.stringify(rotate2)} ${JSON.stringify(lights2)} ${soundIndex}`, "[UDT]");
