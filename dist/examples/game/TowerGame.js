(() => {
  ...
  async function revealPicksOnTower() {
    ...
    const topGlyph = (_a = GLYPHS[GameState.TowerPicks[0]]) != null ? _a : { side: GameState.TowerPicks[0].split(" ")[1] };
    const middleGlyph = (_b = GLYPHS[GameState.TowerPicks[1]]) != null ? _b : { side: GameState.TowerPicks[1].split(" ")[1] };
    const bottomGlyph = (_c = GLYPHS[GameState.TowerPicks[2]]) != null ? _c : { side: GameState.TowerPicks[2].split(" ")[1] };
  ...
  var fireConfettiCannon = () => {
    var scalar = 3;
    var skull = confetti.shapeFromText({ text: "\u{1F480}", scalar });
    confetti({
      particleCount: 100,
      spread: 70,
      origin: { y: 0.6 }
  ...
  var disableDifficultyChange = (setting) => {
  ...
  var pickRandomGlyph = (difficultyLevel) => {
    let glyphs = null;
  ...
  window.challengeTower = challengeTower;
  window.setDifficultyNormal = setDifficultyNormal;
  window.setDifficultyGritty = setDifficultyGritty;
  window.setDifficultyMax = setDifficultyMax;
  window.populateSelections = populateSelections;
  window.resetScore = resetScore;
  window.glyphClick = glyphClick;
})();
