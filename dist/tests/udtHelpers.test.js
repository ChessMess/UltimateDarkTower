...
describe('udtHelpers', () => {
    describe('Battery Voltage Functions', () => {
        describe('milliVoltsToPercentageNumber', () => {
            test('should return 0 for 0 millivolts', () => {
                expect((0, udtHelpers_1.milliVoltsToPercentageNumber)(0)).toBe(0);
            });
            test('should return 0 for very low voltage', () => {
                expect((0, udtHelpers_1.milliVoltsToPercentageNumber)(100)).toBe(0);
            });
            test('should calculate percentage based on VOLTAGE_LEVELS', () => {
                ...
                expect((0, udtHelpers_1.milliVoltsToPercentageNumber)(testVoltage)).toBe(100);
            });
            test('should calculate percentage for mid-range voltage', () => {
                ...
                expect((0, udtHelpers_1.milliVoltsToPercentageNumber)(testVoltage)).toBe(50);
            });
            test('should handle single battery voltage correctly', () => {
                ...
                const levelsMatched = udtConstants_1.VOLTAGE_LEVELS.filter(v => singleBatteryVoltage >= v).length;
                expect((0, udtHelpers_1.milliVoltsToPercentageNumber)(totalVoltage)).toBe(levelsMatched * 5);
            });
            test('should return 100% for maximum voltage', () => {
                const maxVoltage = 2000 * 3; // Well above highest VOLTAGE_LEVEL
                expect((0, udtHelpers_1.milliVoltsToPercentageNumber)(maxVoltage)).toBe(100);
            });
        });
        describe('milliVoltsToPercentage', () => {
            test('should return "0%" for 0 millivolts', () => {
                expect((0, udtHelpers_1.milliVoltsToPercentage)(0)).toBe('0%');
            });
            test('should return percentage string with % symbol', () => {
                const testVoltage = 1175 * 3; // Should be 50%
                expect((0, udtHelpers_1.milliVoltsToPercentage)(testVoltage)).toBe('50%');
            });
            test('should return "100%" for maximum voltage', () => {
                const maxVoltage = 2000 * 3;
                expect((0, udtHelpers_1.milliVoltsToPercentage)(maxVoltage)).toBe('100%');
            });
            test('should match milliVoltsToPercentageNumber but with % suffix', () => {
                const testVoltage = 1200 * 3;
                const numberResult = (0, udtHelpers_1.milliVoltsToPercentageNumber)(testVoltage);
                const stringResult = (0, udtHelpers_1.milliVoltsToPercentage)(testVoltage);
    ...
    describe('getMilliVoltsFromTowerResponse', () => {
        test('should extract voltage from tower response packet', () => {
            ...
            const result = (0, udtHelpers_1.getMilliVoltsFromTowerResponse)(mockResponse);
    ...
    describe('commandToPacketString', () => {
        ...
        test('should handle empty array', () => {
            ...
            expect((0, udtHelpers_1.commandToPacketString)(command)).toBe(']');
        });
    ...
    describe('getTowerPosition', () => {
        describe('Ring Layers (0-2)', () => {
            test('should return cardinal directions for top ring (layer 0)', () => {
                expect((0, udtHelpers_1.getTowerPosition)(0, 0)).toEqual({ level: 'TOP_RING', direction: 'NORTH', ledChannel: 0 });
                expect((0, udtHelpers_1.getTowerPosition)(0, 1)).toEqual({ level: 'TOP_RING', direction: 'EAST', ledChannel: 3 });
                expect((0, udtHelpers_1.getTowerPosition)(0, 2)).toEqual({ level: 'TOP_RING', direction: 'SOUTH', ledChannel: 2 });
                expect((0, udtHelpers_1.getTowerPosition)(0, 3)).toEqual({ level: 'TOP_RING', direction: 'WEST', ledChannel: 1 });
            });
            test('should return cardinal directions for middle ring (layer 1)', () => {
                expect((0, udtHelpers_1.getTowerPosition)(1, 0)).toEqual({ level: 'MIDDLE_RING', direction: 'NORTH', ledChannel: 7 });
                expect((0, udtHelpers_1.getTowerPosition)(1, 1)).toEqual({ level: 'MIDDLE_RING', direction: 'EAST', ledChannel: 6 });
                expect((0, udtHelpers_1.getTowerPosition)(1, 2)).toEqual({ level: 'MIDDLE_RING', direction: 'SOUTH', ledChannel: 5 });
                expect((0, udtHelpers_1.getTowerPosition)(1, 3)).toEqual({ level: 'MIDDLE_RING', direction: 'WEST', ledChannel: 4 });
            });
            test('should return cardinal directions for bottom ring (layer 2)', () => {
                expect((0, udtHelpers_1.getTowerPosition)(2, 0)).toEqual({ level: 'BOTTOM_RING', direction: 'NORTH', ledChannel: 10 });
                expect((0, udtHelpers_1.getTowerPosition)(2, 1)).toEqual({ level: 'BOTTOM_RING', direction: 'EAST', ledChannel: 9 });
                expect((0, udtHelpers_1.getTowerPosition)(2, 2)).toEqual({ level: 'BOTTOM_RING', direction: 'SOUTH', ledChannel: 8 });
                expect((0, udtHelpers_1.getTowerPosition)(2, 3)).toEqual({ level: 'BOTTOM_RING', direction: 'WEST', ledChannel: 11 });
            });
        });
        describe('Ledge/Base Layers (3-5)', () => {
            test('should return ordinal directions for ledge (layer 3)', () => {
                expect((0, udtHelpers_1.getTowerPosition)(3, 0)).toEqual({ level: 'LEDGE', direction: 'NORTH_EAST', ledChannel: 12 });
                expect((0, udtHelpers_1.getTowerPosition)(3, 1)).toEqual({ level: 'LEDGE', direction: 'SOUTH_EAST', ledChannel: 13 });
                expect((0, udtHelpers_1.getTowerPosition)(3, 2)).toEqual({ level: 'LEDGE', direction: 'SOUTH_WEST', ledChannel: 14 });
                expect((0, udtHelpers_1.getTowerPosition)(3, 3)).toEqual({ level: 'LEDGE', direction: 'NORTH_WEST', ledChannel: 15 });
            });
            test('should return ordinal directions for base1 (layer 4)', () => {
                expect((0, udtHelpers_1.getTowerPosition)(4, 0)).toEqual({ level: 'BASE1', direction: 'NORTH_EAST', ledChannel: 16 });
                expect((0, udtHelpers_1.getTowerPosition)(4, 1)).toEqual({ level: 'BASE1', direction: 'SOUTH_EAST', ledChannel: 17 });
                expect((0, udtHelpers_1.getTowerPosition)(4, 2)).toEqual({ level: 'BASE1', direction: 'SOUTH_WEST', ledChannel: 18 });
                expect((0, udtHelpers_1.getTowerPosition)(4, 3)).toEqual({ level: 'BASE1', direction: 'NORTH_WEST', ledChannel: 19 });
            });
            test('should return ordinal directions for base2 (layer 5)', () => {
                expect((0, udtHelpers_1.getTowerPosition)(5, 0)).toEqual({ level: 'BASE2', direction: 'NORTH_EAST', ledChannel: 20 });
                expect((0, udtHelpers_1.getTowerPosition)(5, 1)).toEqual({ level: 'BASE2', direction: 'SOUTH_EAST', ledChannel: 21 });
                expect((0, udtHelpers_1.getTowerPosition)(5, 2)).toEqual({ level: 'BASE2', direction: 'SOUTH_WEST', ledChannel: 22 });
                expect((0, udtHelpers_1.getTowerPosition)(5, 3)).toEqual({ level: 'BASE2', direction: 'NORTH_WEST', ledChannel: 23 });
            });
        });
    });
    describe('getActiveLights', () => {
        test('should return empty array for default tower state', () => {
            ...
            const activeLights = (0, udtHelpers_1.getActiveLights)(defaultState);
        ...
        test('should return active lights with correct position info', () => {
            ...
            const activeLights = (0, udtHelpers_1.getActiveLights)(testState);
    ...
    describe('createDefaultTowerState', () => {
        ...
        test('should create new instances each time', () => {
            const state1 = (0, udtHelpers_1.createDefaultTowerState)();
            const state2 = (0, udtHelpers_1.createDefaultTowerState)();
...
//# sourceMappingURL=udtHelpers.test.js.map