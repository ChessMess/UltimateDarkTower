...
describe('SystemRandom', () => {
    describe('game seed 186022107 (InitializationSeed from AA9A-AAGS-W634)', () => {
        test('Next() sequence matches C#', () => {
            const rng = new udtSystemRandom_1.SystemRandom(186022107);
            const expected = [
    ...
    describe('game seed 186022106 (QuestSeed from AA9A-AAGS-W634)', () => {
        test('Next() sequence matches C#', () => {
            const rng = new udtSystemRandom_1.SystemRandom(186022106);
            const expected = [
    ...
    describe('seed 0', () => {
        test('Next() sequence matches C#', () => {
            const rng = new udtSystemRandom_1.SystemRandom(0);
            const expected = [
    ...
    describe('seed -1 (negative)', () => {
        test('Next() sequence matches C#', () => {
            const rng = new udtSystemRandom_1.SystemRandom(-1);
            const expected = [
    ...
    describe('seed 1', () => {
        test('produces same sequence as seed -1 (Math.Abs)', () => {
            const rng1 = new udtSystemRandom_1.SystemRandom(1);
            const rngNeg = new udtSystemRandom_1.SystemRandom(-1);
            for (let i = 0; i < 10; i++) {
    ...
    describe('seed 42', () => {
        test('Next() sequence matches C#', () => {
            const rng = new udtSystemRandom_1.SystemRandom(42);
            const expected = [
    ...
    describe('Int32.MaxValue (2147483647)', () => {
        test('Next() sequence matches C#', () => {
            const rng = new udtSystemRandom_1.SystemRandom(2147483647);
            const expected = [
    ...
    describe('Int32.MinValue (-2147483648)', () => {
        test('produces same sequence as Int32.MaxValue', () => {
            const rngMin = new udtSystemRandom_1.SystemRandom(-2147483648);
            const rngMax = new udtSystemRandom_1.SystemRandom(2147483647);
            for (let i = 0; i < 10; i++) {
    ...
    describe('edge cases', () => {
        ...
        test('two instances with same seed produce identical sequences', () => {
            const rng1 = new udtSystemRandom_1.SystemRandom(12345);
            const rng2 = new udtSystemRandom_1.SystemRandom(12345);
            for (let i = 0; i < 100; i++) {
        ...
        test('different seeds produce different sequences', () => {
            const rng1 = new udtSystemRandom_1.SystemRandom(1);
            const rng2 = new udtSystemRandom_1.SystemRandom(2);
            let allSame = true;
            for (let i = 0; i < 10; i++) {
        ...
        test('nextRange with a range wider than Int32.MaxValue stays in bounds and is deterministic', () => {
            ...
            const rng1 = new udtSystemRandom_1.SystemRandom(42);
            const rng2 = new udtSystemRandom_1.SystemRandom(42);
            for (let i = 0; i < 50; i++) {
...
//# sourceMappingURL=udtSystemRandom.test.js.map