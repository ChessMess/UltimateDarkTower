...
of _Return to Dark Tower_ (Restoration Games, 2022) — 1 player controlling **up to 4 heroes**, **no
...
seals, etc. UTDD's long-term role is to be the _tower and board that the official app talks to_ — it
...
resume, export it to a file, or send the JSON to a friend who imports it and continues the _identical_
...
unofficial fan companion; _Return to Dark Tower_ art, text, audio © Restoration Games — do not
