...
export function InspectorPanel() {
  ...
  return (
    <div style={style.panel}>
      ...
      {/* Props editor for dungeon.subflow — pick the library dungeon + jump to the Dungeon Builder */}
      {sn.kind === 'dungeon.subflow' && (
        <DungeonSubflowEditor
          sn={sn}
          schemaDoc={schemaDoc}
          onUpdate={(props) => updateNodeProps(sn.id, props)}
