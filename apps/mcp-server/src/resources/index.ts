...
export function registerResources(server: McpServer, tower: TowerController): void {
  ...
  const gameContent = [
    ...
    },
    {
      ...
      file: 'adversaries.md',
      title: 'Adversaries',
      desc: 'Adversary overview — escalation and quest mechanics (summary; the per-adversary card details are still being filled in)',
    },
    {
      name: 'game-quests',
      ...
      file: 'quests.md',
      title: 'Quests',
      desc: 'Quest types and completion conditions (summary; specific main goals and reward details are still being filled in)',
    },
    {
      name: 'game-items',
      ...
      file: 'items.md',
      title: 'Items',
      desc: 'Item categories and how items work (summary; specific card names, effects, and costs are still being filled in)',
    },
    {
      name: 'game-heroes',
      ...
      file: 'heroes.md',
      title: 'Heroes',
      desc: 'Hero overview and setup (summary; per-hero abilities and virtue-tile text are still being filled in)',
    },
    {
      name: 'game-buildings',
    ...
    },
    {
      ...
      file: 'lore.md',
      title: 'Lore',
      desc: 'World lore overview (summary; deeper histories, named locations, and flavor text are still being filled in)',
    },
    {
      name: 'game-glossary',
