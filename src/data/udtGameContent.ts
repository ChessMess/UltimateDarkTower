...
export const HEROES = {
        ...
        unlockableVirtues: [
            {
                name: 'Infused',
                ability:
                    'At the start of your turn, remove 1 skull from a building in your home kingdom.',
            },
            {
                name: 'Blessed',
                ability:
            ...
            },
            {
                name: 'Anointed',
                ability:
                    '+1 Wild Advantage for each building with no skulls on or adjacent to your space.',
            },
        ],
    },
    'Relic Hunter': {
        ...
        unlockableVirtues: [
            { name: 'Crafty', ability: 'When you spend a potion, double the number on it.' },
            {
                name: 'Lucky',
                ability:
                    'When you spend (not lose) a treasure, gain the top card of the treasure deck.',
            },
    ...
    'Haunted Recluse': {
        ...
        expansion: 'Alliances',
        bannerAction:
            'Move 1 skull from any building to any other building with 2 or fewer skulls.',
        defaultVirtues: [
        ...
        unlockableVirtues: [
            {
                name: 'Shadowspinner',
                ability:
                    '+1 Wild Advantage for each building with skulls on or adjacent to your space.',
            },
            {
                name: 'Soulreaper',
                ability:
    ...
    Archwright: {
        ...
        unlockableVirtues: [
            ...
            },
            {
                name: 'Wily',
                ability:
                    'Battlements give you advantages when you Quest (in addition to when you Battle).',
            },
            {
                name: 'Exalted',
                ability:
    ...
    'Relentless Warden': {
        ...
        defaultVirtues: [
            { name: 'Perceptive', ability: '+1 Wild Advantage vs. your quarry.' },
            {
                name: 'Guarded',
                ability:
                    'Prevent up to 3 warrior losses per battle card when you Battle your quarry.',
            },
        ],
        unlockableVirtues: [
            { name: 'Keen-Eyed', ability: '+2 Wild Advantages vs. your quarry.' },
            {
                name: 'Instinctive',
                ability:
                    'You may remove your quarry token to ignore your quarry during its strike event.',
            },
            {
                name: 'Inspiring',
                ability:
                    'When you defeat your quarry, remove all skulls on or adjacent to your space.',
            },
        ],
    },
    'Undaunted Aegis': {
        ...
        defaultVirtues: [
            ...
            },
            {
                name: 'Iron-Willed',
                ability:
                    'You can have an additional corruption. Start the game with 1 random corruption.',
            },
        ],
        unlockableVirtues: [
        ...
        unlockableVirtues: [
            {
                name: 'Fortuitous',
                ability:
                    'After you roll the haggle die, you may reroll once and take either result.',
            },
            {
                name: 'Opportunistic',
                ability:
                    'When any player gains a treasure from the treasure market, you gain a blessing.',
            },
            {
                name: 'Calculating',
    ...
    'Reverent Astromancer': {
        ...
        unlockableVirtues: [
            ...
            { name: 'Zealous', ability: 'Whenever you cast a spell, gain a blessing.' },
            {
                name: 'Bounteous',
                ability:
                    'Once per turn, when you cast a spell, gain the top card of the treasure deck.',
            },
        ],
    },
