...
const cond = (subject: ConditionSubject, comparator: Comparator, value: unknown, key?: string) =>
...
const golden = {
  ...
  meta: {
    ...
    description:
      'Playable golden MVP fixture — drives to a clean win and a clean loss (rules-engine §9).',
  ...
  setup: {
    ...
    monthEnd: {
      ...
      default: { minTurn: 3, maxTurn: 6 },
      perMonth: { '6': { minTurn: 2, maxTurn: 4 } },
    },
    selections: {
  ...
  library: {
    buildingTypes: {
      ...
      sanctuary: buildingType({ op: 'resource.gain', resource: 'spirit', amount: 1 }, 5, {
        op: 'corruption.remove',
        all: true,
      }),
      village: buildingType({ op: 'resource.gain', resource: 'warriors', amount: 6 }, 1, {
        op: 'resource.gain',
        resource: 'warriors',
        amount: 12,
      }),
      bazaar: buildingType({ op: 'item.gain', itemType: 'gear' }, 2, {
        op: 'item.gain',
        itemType: 'treasure',
        from: 'market',
      }),
    ...
    foes: {
      brigands: {
        ...
        traits: ['Humanoid', 'Melee'],
        strike: {
          cadence: 'monthly',
          effects: [{ op: 'resource.lose', resource: 'warriors', amount: 1 }],
        },
    ...
    quests: {
      ...
      'recover-azkols-treasures': {
        ...
        requirements: [
          {
            label: 'The vault relic is recovered',
            condition: cond('flag', 'eq', true, 'vaultCleared'),
          },
          {
            label: 'The shrine relic is recovered',
            condition: cond('flag', 'eq', true, 'shrineRelicFound'),
          },
          {
            label: 'Stand before the Dark Tower',
            condition: cond('heroAtLocation', 'gte', 1, 'the-tower'),
          },
        ],
        outcomes: {
          success: [{ op: 'flag.set', name: 'goalDone', value: true }],
      ...
      'azkol-vault': {
        ...
        outcomes: {
          success: [{ op: 'resource.gain', resource: 'spirit', amount: 1 }],
          failure: [],
        },
      },
      ...
      'zaida-escort': {
        ...
        requirements: [
          { label: 'Reach Delmsmire', condition: cond('heroAtLocation', 'gte', 1, 'Delmsmire') },
        ],
        outcomes: {
          success: [{ op: 'resource.gain', resource: 'spirit', amount: 1 }],
          failure: [],
      ...
      'adv-quest-m2': {
        id: 'adv-quest-m2',
        name: "Disrupt the Ashstrider's Scouts",
        requirements: [
        ...
        outcomes: {
          success: [{ op: 'resource.spend', resource: 'warriors', amount: 1 }],
          failure: [{ op: 'skull.place', count: 1, kingdom: 'north' }],
        },
      },
      'adv-quest-m3': {
        id: 'adv-quest-m3',
        name: "Burn the Ashstrider's Totems",
        requirements: [
          {
            label: 'Reach Broken Lands',
            condition: cond('heroAtLocation', 'gte', 1, 'Broken Lands'),
          },
          { label: '1 warrior to spend', condition: cond('resource', 'gte', 1, 'warriors') },
        ],
        outcomes: {
      ...
      'adv-quest-m4': {
        id: 'adv-quest-m4',
        name: 'Scatter the Ash Cults',
        requirements: [
          {
            label: 'Reach Muted Forest',
            condition: cond('heroAtLocation', 'gte', 1, 'Muted Forest'),
          },
          { label: '1 warrior to spend', condition: cond('resource', 'gte', 1, 'warriors') },
        ],
        outcomes: {
      ...
      'adv-quest-m5': {
        id: 'adv-quest-m5',
        name: 'Break the Siege Lines',
        requirements: [
          {
            label: 'Reach Green Bridge',
            condition: cond('heroAtLocation', 'gte', 1, 'Green Bridge'),
          },
          { label: '1 warrior to spend', condition: cond('resource', 'gte', 1, 'warriors') },
        ],
        outcomes: {
      ...
      'adv-quest-m6': {
        id: 'adv-quest-m6',
        name: 'Hold the Last Road',
        requirements: [
          {
            label: 'Reach Pearl of the North',
            condition: cond('heroAtLocation', 'gte', 1, 'Pearl of the North'),
          },
          { label: '1 warrior to spend', condition: cond('resource', 'gte', 1, 'warriors') },
        ],
        outcomes: {
        ...
        rooms: [
          {
            ...
            name: 'Antechamber',
            cell: { col: 0, row: 0 },
            exits: { N: 'wall', E: 'door', S: 'wall', W: 'wall' },
            isEntrance: true,
            displayText: 'A cold antechamber.',
          ...
          },
          {
            ...
            name: 'Warded Hall',
            cell: { col: 1, row: 0 },
            exits: { N: 'wall', E: 'door', S: 'wall', W: 'door' },
          ...
          },
          {
            ...
            name: 'Reliquary',
            cell: { col: 2, row: 0 },
            exits: { N: 'wall', E: 'wall', S: 'wall', W: 'door' },
            isTarget: true,
            displayText: "Azkol's reliquary.",
      ...
      dragons: {
        cards: [
          ...
          { advantage: 'Wild', strikes: 1 },
          {
            ...
            strikes: 1,
            critical: true,
            note: 'dragonfire — cannot be improved',
          },
        ],
      },
  ...
  graph: {
    ...
    nodes: [
      ...
      },
      {
        id: 'n-banner',
        kind: 'action.banner',
        props: { title: "Recover Azkol's Treasures" },
        wires: { out: ['n-month'] },
      },
      ...
      {
        id: 'n-amid',
        kind: 'lifecycle.actionMiddle',
        wires: { out: ['n-aend'], battle: ['n-bsel'], dungeon: ['n-dsub'], trade: ['n-trade'] },
      },
      ...
      // Dungeon subflow (catalog §5): enter → entrance room; rooms wired N/E/S/W (doors); completed/left return to actionEnd.
      {
        ...
        props: { dungeonId: 'azkol-vault-dungeon' },
        wires: { enter: ['n-room-a'], completed: ['n-aend'], left: ['n-aend'] },
      },
      {
        id: 'n-room-a',
        kind: 'dungeon.room',
        props: { roomId: 'vault-entry' },
        wires: { E: ['n-room-b'] },
      },
      {
        id: 'n-room-b',
        kind: 'dungeon.room',
        props: { roomId: 'vault-hall' },
        wires: { W: ['n-room-a'], E: ['n-room-c'] },
      },
      {
        id: 'n-room-c',
        kind: 'dungeon.room',
        props: { roomId: 'vault-target' },
        wires: { W: ['n-room-b'] },
      },
      ...
      // to Action: End. Reachable from Action: Middle's `trade` port (resolved by _spine.tradeEntry).
      {
        id: 'n-trade',
        kind: 'action.trade',
        props: { from: 'hero1', to: 'hero2', give: [{ asset: 'warriors', amount: 1 }] },
        wires: { out: ['n-aend'] },
      },
      ...
      { id: 'n-nmc', kind: 'lifecycle.newMonthCheck', wires: { out: ['n-endeval'] } },
      {
        ...
        props: { condition: cond('flag', 'eq', true, 'adversaryDefeated') },
        wires: { out: ['n-end'] },
      },
...
function cloneAuthoredLossSeal() {
  ...
  nodes.splice(
    ...
    0,
    {
      id: 'n-sealbreak',
      kind: 'effect.apply',
      props: { effects: [{ op: 'seal.remove' }] },
      wires: { out: ['n-lossguard'] },
    },
    {
      id: 'n-lossguard',
      kind: 'winloss.lossCondition',
      props: { condition: cond('sealsRemoved', 'gte', 2) },
      wires: { out: ['n-aend'] },
    },
  );
  return c;
...
function cloneAuthoredLossFoe() {
  ...
  nodes.splice(
    ...
    0,
    {
      id: 'n-foespawn',
      kind: 'effect.apply',
      props: { effects: [{ op: 'foe.spawn', foeId: 'brigands', location: 'the-tower' }] },
      wires: { out: ['n-lossguard'] },
    },
    {
      id: 'n-lossguard',
      kind: 'winloss.lossCondition',
      props: { condition: cond('foeOnSpace', 'gte', 2, 'the-tower') },
      wires: { out: ['n-aend'] },
    },
  );
  return c;
...
function buildGoldenFull() {
  const c = JSON.parse(JSON.stringify(golden));
  c.meta.description =
    'Base-game fidelity golden scenario — full turn structure, buildings, events, monthly quests (rules.md).';
  ...
  c.setup.board = {
    boardState: {
      home: {
        north: 'Radiant Mountains',
        east: 'Inner Kinghills',
        west: 'Hissing Groves',
        south: 'Howling Desert',
      },
      buildings: [
  ...
  nodes.push(
    ...
    // end-of-turn events (rules.md §Events) — scheduled by turn-of-month
    {
      ...
      props: { trigger: { on: 'schedule', turn: 1 } },
      wires: { out: ['n-ev-stirs'] },
    },
    { id: 'n-ev-stirs', kind: 'event.towerStirs', props: { level: 'top' }, wires: {} },
    {
      ...
      kind: 'trigger.schedule',
      props: { trigger: { on: 'schedule', turn: 1 } },
      wires: { out: ['n-ev-wares'] },
    },
    {
      id: 'n-ev-wares',
      kind: 'event.newWares',
      props: { cards: ['azkol-idol', 'wyrm-scale', 'warded-lantern'] },
      wires: {},
    },
    {
      id: 'n-trig-strike',
      kind: 'trigger.schedule',
      props: { trigger: { on: 'schedule', turn: 2 } },
      wires: { out: ['n-ev-strike'] },
    },
    { id: 'n-ev-strike', kind: 'event.foesStrike', wires: {} },
    {
      id: 'n-trig-grow',
      kind: 'trigger.schedule',
      props: { trigger: { on: 'schedule', turn: 3 } },
      wires: { out: ['n-ev-grow'] },
    },
    ...
    'frost-trolls': {
      cards: [
        ...
        },
        {
          ...
          steps: [
            {
              text: 'Shattered — lose 7 warriors and 1 spirit',
              effects: [...ll(7), ...ll(1, 'spirit')],
            },
  ...
  c.library.resources = {
    images: {
      'deck-back': svgUrl(
        `<svg xmlns="http://www.w3.org/2000/svg" width="750" height="1050" viewBox="0 0 750 1050"><rect width="750" height="1050" fill="#241826"/><rect x="40" y="40" width="670" height="970" rx="28" fill="none" stroke="#c0392b" stroke-width="10"/><circle cx="375" cy="525" r="150" fill="none" stroke="#c0392b" stroke-width="8"/><text x="375" y="560" font-size="130" text-anchor="middle" fill="#e8d9c0" font-family="serif">A</text></svg>`,
      ),
      'art-brigand-raid': svgUrl(
        `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600"><rect width="600" height="600" fill="#2b1d15"/><polygon points="0,600 250,180 350,180 600,600" fill="#6b4a2b"/><circle cx="300" cy="150" r="70" fill="#e8b04b"/></svg>`,
      ),
      'art-brigand-cutthroat': svgUrl(
        `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600"><rect width="600" height="600" fill="#1a0e0e"/><polygon points="300,60 340,420 300,470 260,420" fill="#d64545"/><rect x="270" y="440" width="60" height="90" fill="#7a4a2b"/></svg>`,
      ),
      'art-treasure-crown': svgUrl(
        `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600"><rect width="600" height="600" fill="#141026"/><polygon points="150,420 150,240 240,320 300,200 360,320 450,240 450,420" fill="#ffd166"/><rect x="150" y="420" width="300" height="50" fill="#e0a53a"/></svg>`,
      ),
      'art-treasure-scepter': svgUrl(
        `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600"><rect width="600" height="600" fill="#101826"/><rect x="285" y="200" width="30" height="300" fill="#c9a24b"/><circle cx="300" cy="180" r="60" fill="#8ec5ff"/></svg>`,
      ),
    },
  };
  // Brigands battle deck: presentational back/template/accent + front art on two of its cards.
  c.library.battleDefs.brigands.appearance = {
    backRef: 'deck-back',
    template: 'classic',
    accent: '#c0392b',
  };
  ...
  c.library.cards = {
    'azkol-crown': {
      ...
      artRef: 'art-treasure-crown',
      effects: [{ op: 'resource.gain', resource: 'spirit', amount: 2 }],
    },
    'azkol-scepter': {
      id: 'azkol-scepter',
      name: 'Scepter of Azkol',
      type: 'treasure',
      description: 'Gain 2 warriors.',
      flavor: 'It still commands.',
      artRef: 'art-treasure-scepter',
    ...
    'azkol-chalice': {
      ...
      type: 'treasure',
      description: 'Gain 1 warrior and 1 spirit.',
      flavor: 'Drink deep.',
      effects: [
        { op: 'resource.gain', resource: 'warriors', amount: 1 },
        { op: 'resource.gain', resource: 'spirit', amount: 1 },
      ],
    },
  };
  c.library.decks = {
