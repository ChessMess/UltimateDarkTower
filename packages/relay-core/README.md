...
<p align="center">
  The headless engine behind <a href="https://github.com/ChessMess/UltimateDarkTower"><strong>UltimateDarkTowerRelay</strong></a> — a BLE tower-emulator peripheral and WebSocket relay for <em>Return to Dark Tower</em>.
</p>
...
<p align="center">
  ...
  <a href="https://github.com/ChessMess/UltimateDarkTower/blob/main/LICENSE"><img alt="license" src="https://img.shields.io/npm/l/ultimatedarktowerrelay-core.svg"></a>
...
For a ready-to-run daemon, see the CLI and Electron operator console in the [main repo](https://github.com/ChessMess/UltimateDarkTower).

## Documentation

- [Architecture](https://github.com/ChessMess/UltimateDarkTower/blob/main/docs/relay/ARCHITECTURE.md) · [Tower emulator behavior](https://github.com/ChessMess/UltimateDarkTower/blob/main/docs/relay/TOWER_EMULATOR.md)
- [Per-platform setup](https://github.com/ChessMess/UltimateDarkTower/blob/main/docs/relay/SETUP.md) · [Troubleshooting](https://github.com/ChessMess/UltimateDarkTower/blob/main/docs/relay/TROUBLESHOOTING.md)
