...
- 0d06832: Add `BoardDefinition` injection so hosts can render a board this package doesn't ship (custom
...
- 6a89e0e: Depend on `ultimatedarktowerdata` directly instead of `ultimatedarktower`, for the board/hero/foe
...
- Updated dependencies [b5c7541]
  - ultimatedarktowerdisplay@0.10.4
