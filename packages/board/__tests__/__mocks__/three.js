...
// Mirrors the core THREE.Timer API surface used by Display's Tower3DView.
class Timer {
  update() {
    return this;
  }
...
const {
  ...
  Scene: __e_Scene,
  Group: __e_Group,
  BufferGeometry: __e_BufferGeometry,
  BufferAttribute: __e_BufferAttribute,
  DoubleSide: __e_DoubleSide,
  FrontSide: __e_FrontSide,
...
export {
  ...
  __e_Scene as Scene,
  __e_Group as Group,
  __e_BufferGeometry as BufferGeometry,
  __e_BufferAttribute as BufferAttribute,
  __e_DoubleSide as DoubleSide,
  __e_FrontSide as FrontSide,
