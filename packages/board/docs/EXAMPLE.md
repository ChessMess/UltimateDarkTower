...
stores the UI reads. The **inspector** edits/removes whatever is selected. *Hero + monument add are
deferred until UDT ships those rosters (M4 spec §8); a hero placed in code can still be edited.*
