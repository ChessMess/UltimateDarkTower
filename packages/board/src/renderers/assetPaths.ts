...
const OFFICIAL_2D_ICON: Partial<Record<'foe' | 'adversary' | 'skull', Record<string, string>>> = {
  foe: {
    ...
    'shadow-wolves': 'shadow-wolves-token.png',
    'spine-fiends': 'spine-fiend-token.png',
    'frost-trolls': 'frost-troll-token.png',
    'clan-of-neuri': 'clan-of-neuri-token.png',
    lemures: 'lemure-token.png',
    'widowmade-spiders': 'widowmade-spider-token.png',
    dragons: 'dragon-token.png',
    mormos: 'mormo-token.png',
    striga: 'striga-token.png',
    titans: 'titan-token.png',
  },
  adversary: {
