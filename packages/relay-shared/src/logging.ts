/**
 * Shared logging types and command decoder for UltimateDarkTowerRelay.
 *
 * Defines the JSONL log entry format used by both the host file logger and
 * the consumer client rolling buffer. Also provides a lightweight command
 ...
 * core package) imports UDT constants for human-readable names.
 */
