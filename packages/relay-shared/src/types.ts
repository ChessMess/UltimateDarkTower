/**
 * Shared TypeScript interfaces and types for UltimateDarkTowerRelay.
 *
 * These types are used by both the relay core (Node.js BLE relay server) and
 * the consumer client SDK.
 */
