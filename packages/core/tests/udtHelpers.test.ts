  ...
  describe('getTowerPosition', () => {
    describe('Ring Layers (0-2)', () => {
      test('should return cardinal directions for top ring (layer 0)', () => {
        expect(getTowerPosition(0, 0)).toEqual({
          level: 'TOP_RING',
          direction: 'NORTH',
          ledChannel: 0,
        });
        expect(getTowerPosition(0, 1)).toEqual({
          level: 'TOP_RING',
          direction: 'EAST',
          ledChannel: 3,
        });
        expect(getTowerPosition(0, 2)).toEqual({
          level: 'TOP_RING',
          direction: 'SOUTH',
          ledChannel: 2,
        });
        expect(getTowerPosition(0, 3)).toEqual({
          level: 'TOP_RING',
          direction: 'WEST',
          ledChannel: 1,
        });
      ...
      test('should return cardinal directions for middle ring (layer 1)', () => {
        expect(getTowerPosition(1, 0)).toEqual({
          level: 'MIDDLE_RING',
          direction: 'NORTH',
          ledChannel: 7,
        });
        expect(getTowerPosition(1, 1)).toEqual({
          level: 'MIDDLE_RING',
          direction: 'EAST',
          ledChannel: 6,
        });
        expect(getTowerPosition(1, 2)).toEqual({
          level: 'MIDDLE_RING',
          direction: 'SOUTH',
          ledChannel: 5,
        });
        expect(getTowerPosition(1, 3)).toEqual({
          level: 'MIDDLE_RING',
          direction: 'WEST',
          ledChannel: 4,
        });
      ...
      test('should return cardinal directions for bottom ring (layer 2)', () => {
        expect(getTowerPosition(2, 0)).toEqual({
          level: 'BOTTOM_RING',
          direction: 'NORTH',
          ledChannel: 10,
        });
        expect(getTowerPosition(2, 1)).toEqual({
          level: 'BOTTOM_RING',
          direction: 'EAST',
          ledChannel: 9,
        });
        expect(getTowerPosition(2, 2)).toEqual({
          level: 'BOTTOM_RING',
          direction: 'SOUTH',
          ledChannel: 8,
        });
        expect(getTowerPosition(2, 3)).toEqual({
          level: 'BOTTOM_RING',
          direction: 'WEST',
          ledChannel: 11,
        });
    ...
    describe('Ledge/Base Layers (3-5)', () => {
      test('should return ordinal directions for ledge (layer 3)', () => {
        expect(getTowerPosition(3, 0)).toEqual({
          level: 'LEDGE',
          direction: 'NORTH_EAST',
          ledChannel: 12,
        });
        expect(getTowerPosition(3, 1)).toEqual({
          level: 'LEDGE',
          direction: 'SOUTH_EAST',
          ledChannel: 13,
        });
        expect(getTowerPosition(3, 2)).toEqual({
          level: 'LEDGE',
          direction: 'SOUTH_WEST',
          ledChannel: 14,
        });
        expect(getTowerPosition(3, 3)).toEqual({
          level: 'LEDGE',
      ...
      test('should return ordinal directions for base1 (layer 4)', () => {
        expect(getTowerPosition(4, 0)).toEqual({
          level: 'BASE1',
          direction: 'NORTH_EAST',
          ledChannel: 16,
        });
        expect(getTowerPosition(4, 1)).toEqual({
          level: 'BASE1',
          direction: 'SOUTH_EAST',
          ledChannel: 17,
        });
        expect(getTowerPosition(4, 2)).toEqual({
          level: 'BASE1',
          direction: 'SOUTH_WEST',
          ledChannel: 18,
        });
        expect(getTowerPosition(4, 3)).toEqual({
          level: 'BASE1',
          direction: 'NORTH_WEST',
          ledChannel: 19,
        });
      ...
      test('should return ordinal directions for base2 (layer 5)', () => {
        expect(getTowerPosition(5, 0)).toEqual({
          level: 'BASE2',
          direction: 'NORTH_EAST',
          ledChannel: 20,
        });
        expect(getTowerPosition(5, 1)).toEqual({
          level: 'BASE2',
          direction: 'SOUTH_EAST',
          ledChannel: 21,
        });
        expect(getTowerPosition(5, 2)).toEqual({
          level: 'BASE2',
          direction: 'SOUTH_WEST',
          ledChannel: 22,
        });
        expect(getTowerPosition(5, 3)).toEqual({
          level: 'BASE2',
          direction: 'NORTH_WEST',
          ledChannel: 23,
        });
