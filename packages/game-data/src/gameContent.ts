...
// Gameplay-facing data for UDT apps. Box/component counts live in boxInventory.ts.
// Foe/adversary names are reconciled with foes.ts and TOWER_AUDIO_LIBRARY (see constants.ts).
...
export const FOES = {
  ...
  'Spine Fiends': { name: 'Spine Fiends', level: 2 },
  'Clan of Neuri': { name: 'Clan of Neuri', level: 3 },
  'Frost Trolls': { name: 'Frost Trolls', level: 3 },
  Lemures: { name: 'Lemures', level: 3 },
  'Widowmade Spiders': { name: 'Widowmade Spiders', level: 3 },
  Dragons: { name: 'Dragons', level: 4 },
  Mormos: { name: 'Mormos', level: 4 },
  Striga: { name: 'Striga', level: 4 },
  Titans: { name: 'Titans', level: 4 },
