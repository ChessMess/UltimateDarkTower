    ...
    categories: [
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'Spine Fiends', level: 2, count: 6 },
          { name: 'Clan of Neuri', level: 3, count: 5 },
          { name: 'Frost Trolls', level: 3, count: 4 },
          { name: 'Lemures', level: 3, count: 6 },
          { name: 'Widowmade Spiders', level: 3, count: 5 },
          { name: 'Dragons', level: 4, count: 2 },
          { name: 'Mormos', level: 4, count: 4 },
          { name: 'Striga', level: 4, count: 2 },
          { name: 'Titans', level: 4, count: 1 },
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'Vasa', description: 'The Divine', count: 1 },
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'Spine Fiends', level: 2, count: 1 },
          { name: 'Clan of Neuri', level: 3, count: 1 },
          { name: 'Frost Trolls', level: 3, count: 1 },
          { name: 'Lemures', level: 3, count: 1 },
          { name: 'Widowmade Spiders', level: 3, count: 1 },
          { name: 'Dragons', level: 4, count: 1 },
          { name: 'Mormos', level: 4, count: 1 },
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'Consecrate Arkartus', type: 'Sacrifice', count: 1 },
          { name: "Lay Plovo's Ghost to Rest", type: 'Sacrifice', count: 1 },
          { name: 'Repair the Weeping Dam', type: 'Sacrifice', count: 1 },
    ...
    categories: [
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'Diadem of the Emissary', count: 1 },
          ...
          { name: 'Ring of the Emissary', count: 1 },
          ...
          { name: 'Vestments of the Emissary', count: 1 },
    ...
    categories: [
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'Opal of Projection', count: 1 },
          { name: "Orphaned Scion's Charm", count: 1 },
    ...
    categories: [
      {
        ...
        section: 'Minis',
        components: [
          { name: 'Brigands', count: 8 },
          { name: 'Clan of Neuri', count: 5 },
          { name: 'Isa the Exile', count: 1 },
          { name: 'Lemures', count: 6 },
          { name: 'Mormos', count: 4 },
          { name: 'Oreks', count: 6 },
          { name: 'Shadow Wolves', count: 8 },
          { name: 'Spine Fiends', count: 6 },
          { name: 'Widowmade Spiders', count: 5 },
        ],
      },
      {
